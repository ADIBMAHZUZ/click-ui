    ...
    /***/ function (module, exports, __webpack_require__) {
      ...
      var PDFViewerApplication = {
        ...
        load: function load(pdfDocument) {
          ...
          var pageLayoutPromise = pdfDocument
            .getPageLayout()
            ['catch'](function () {});
          var pageModePromise = pdfDocument
            .getPageMode()
            ['catch'](function () {});
                          ...
                          switch ((_context8.prev = _context8.next)) {
                            case 0:
                              ...
                              if (
                                ...
                                spreadMode = apiPageLayoutToSpreadMode(
                                  pageLayout
                                );
                              }
          ...
          if (viewerId) {
            ...
            if (trigger == 'true') {
              window.parent.postMessage(
                { viewerId: viewerId, event: 'beforePrint' },
                '*'
              );
            }
          } //c1e
        ...
        afterPrint: function pdfViewSetupAfterPrint() {
          ...
          if (viewerId) {
            ...
            if (trigger == 'true') {
              window.parent.postMessage(
                { viewerId: viewerId, event: 'afterPrint' },
                '*'
              );
            }
          } //c1e
      ...
      function webViewerPageChanging(evt) {
        ...
        if (viewerId) {
          ...
          if (trigger == 'true') {
            window.parent.postMessage(
              { viewerId: viewerId, event: 'pageChange', param: page },
              '*'
            );
          }
        } //c1e
    ...
    /***/ function (module, exports, __webpack_require__) {
      ...
      window.applyParameterOverride = function (config) {
        ...
        if (window.getUrlParameterByName('viewBookmark') === 'false') {
          ...
          config.secondaryToolbar.viewBookmarkButton.setAttribute(
            'hidden',
            'true'
          );
        }
        ...
        if (window.getUrlParameterByName('fullScreen') === 'false') {
          ...
          config.secondaryToolbar.presentationModeButton.classList.add(
            'hidden'
          );
        }
                        ...
                        while (1) {
                          switch ((_context2.prev = _context2.next)) {
                            ...
                            case 2:
                              ...
                              isPortrait = (0, _ui_utils.isPortraitOrientation)(
                                pageSizeInches
                              );
                              sizeInches = {
                                width:
                                  Math.round(pageSizeInches.width * 100) / 100,
                                height:
                                  Math.round(pageSizeInches.height * 100) / 100,
                              };
                              sizeMillimeters = {
                                width:
                                  Math.round(pageSizeInches.width * 25.4 * 10) /
                                  10,
                                height:
                                  Math.round(
                    ...
                    return _regenerator['default'].wrap(
                      function _callee3$(_context3) {
                        while (1) {
                          switch ((_context3.prev = _context3.next)) {
                            case 0:
                              dateObject = _pdfjsLib.PDFDateString.toDateObject(
                                inputDate
                              );
            ...
            this.applyActionsOverride = function () {
              ...
              if (scroll) {
                ...
                switch (scroll) {
                  ...
                  case 'H':
                    {
                      PDFViewerApplication.pdfViewer.scrollMode =
