!(function (e) {
  ...
  function (e, t, n) {
      ...
      V = {
                    ...
                    switch ((e.prev = e.next)) {
                      ...
                      case 11:
                        this.bindEvents(),
                          ...
                          (n = t.appContainer || document.documentElement),
                          this.l10n.translate(n).then(function () {
                            i.eventBus.dispatch('localized', { source: i });
                          }),
                          (this.initialized = !0);
                      case 16:
                      case 'end':
              ...
              return r.default.wrap(
                function (e) {
                  for (;;)
                    switch ((e.prev = e.next)) {
                      case 0:
                        if (!0 !== o.AppOptions.get('disablePreferences')) {
                          e.next = 2;
                          break;
                        }
                      ...
                      case 2:
                        return (
                          (e.prev = 2), (e.next = 5), this.preferences.getAll()
                        );
                      case 5:
                        for (n in (t = e.sent)) o.AppOptions.set(n, t[n]);
                        e.next = 12;
                        break;
                      case 9:
                        (e.prev = 9),
                          (e.t0 = e.catch(2)),
                          console.error(
                            '_readPreferences: "'.concat(e.t0.message, '".')
                          );
                      case 12:
                      case 'end':
                        return e.stop();
                    ...
                    switch ((e.prev = e.next)) {
                      ...
                      case 2:
                        if (
                          ...
                          'disableworker' in (i = (0, a.parseQueryString)(n)) &&
                      ...
                      case 23:
                        return (
                          ...
                          e.abrupt(
                            'return',
                            Promise.all(t).catch(function (e) {
                              console.error(
                    ...
                    switch ((e.prev = e.next)) {
                      case 0:
                        (t = this.appConfig),
                          ...
                          (n =
                            t.eventBus ||
                            (0, a.getGlobalEventBus)(
                              o.AppOptions.get('eventBusDispatchToDOM')
                            )),
                          (this.eventBus = n),
                          ((i = new l.PDFRenderingQueue()).onIdle = this.cleanup.bind(
                            this
                          )),
                          (this.pdfRenderingQueue = i),
                          (s = new w.PDFLinkService({
                            eventBus: n,
                            externalLinkTarget: o.AppOptions.get(
                              'externalLinkTarget'
                            ),
                            externalLinkRel: o.AppOptions.get(
                              'externalLinkRel'
                            ),
                          })),
                          (this.pdfLinkService = s),
                          (L = this.externalServices.createDownloadManager({
                            disableCreateObjectURL: o.AppOptions.get(
                              'disableCreateObjectURL'
                            ),
                          })),
                          (this.downloadManager = L),
                          (C = new g.PDFFindController({
                            linkService: s,
                            eventBus: n,
                          })),
                          (this.findController = C),
                          (T = t.mainContainer),
                          (I = t.viewerContainer),
                          (this.pdfViewer = new S.PDFViewer({
                            container: T,
                            viewer: I,
                            eventBus: n,
                            renderingQueue: i,
                            ...
                            imageResourcesPath: o.AppOptions.get(
                              'imageResourcesPath'
                            ),
                            ...
                            maxCanvasPixels: o.AppOptions.get(
                              'maxCanvasPixels'
                            ),
                          })),
                          i.setViewer(this.pdfViewer),
                          s.setViewer(this.pdfViewer),
                          (this.pdfThumbnailViewer = new P.PDFThumbnailViewer({
                            container: t.sidebar.thumbnailView,
                            renderingQueue: i,
                            linkService: s,
                            l10n: this.l10n,
                          })),
                          i.setThumbnailViewer(this.pdfThumbnailViewer),
                          (this.pdfHistory = new m.PDFHistory({
                            linkService: s,
                            eventBus: n,
                          })),
                          s.setHistory(this.pdfHistory),
                          (this.findBar = new v.PDFFindBar(
                            t.findBar,
                            n,
                            this.l10n
                          )),
                          ...
                          (this.pdfCursorTools = new u.PDFCursorTools({
                            container: T,
                            eventBus: n,
                            cursorToolOnLoad: o.AppOptions.get(
                              'cursorToolOnLoad'
                            ),
                          })),
                          (this.toolbar = new E.Toolbar(
                            t.toolbar,
                            n,
                            this.l10n
                          )),
                          (this.secondaryToolbar = new k.SecondaryToolbar(
                            t.secondaryToolbar,
                            T,
                            n
                          )),
                          ...
                          (this.pdfOutlineViewer = new y.PDFOutlineViewer({
                            container: t.sidebar.outlineView,
                            eventBus: n,
                            linkService: s,
                          })),
                          (this.pdfAttachmentViewer = new f.PDFAttachmentViewer(
                            {
                          ...
                          (this.pdfSidebar = new c.PDFSidebar({
                            elements: t.sidebar,
                            pdfViewer: this.pdfViewer,
                          ...
                          (this.pdfSidebarResizer = new _.PDFSidebarResizer(
                            t.sidebarResizer,
                            n,
                            this.l10n
                          ));
        ...
        zoomReset: function () {
          ...
          this.pdfViewer.isInPresentationMode ||
            (e && this.pdfViewer.currentScaleValue === a.DEFAULT_SCALE_VALUE) ||
        ...
        get supportsPrinting() {
          return Be.instance.supportsPrinting;
        },
                ...
                function (e) {
                  for (;;)
                    switch ((e.prev = e.next)) {
                      case 0:
                        if (
                          (this.appConfig.errorWrapper.container.setAttribute(
                            'hidden',
                            'true'
                          ),
                          this.pdfLoadingTask)
                ...
                function (e) {
                  for (;;)
                    switch ((e.prev = e.next)) {
                      ...
                      case 3:
                        for (a in (i = o.AppOptions.getAll(
                          o.OptionKind.WORKER
                        )))
                          s.GlobalWorkerOptions[a] = i[a];
                        for (c in ((u = Object.create(null)),
                        'string' == typeof t
                          ? (this.setTitleUsingUrl(t), (u.url = t))
                          : t && 'byteLength' in t
                          ? (u.data = t)
                          : t.url &&
                            t.originalUrl &&
                            ...
                            (u.url = t.url)),
                        (l = o.AppOptions.getAll(o.OptionKind.API))))
                          u[c] = l[c];
                        if (n)
                          for (d in n)
                            'length' === d &&
                              this.pdfDocumentProperties.setFileSize(n[d]),
                              (u[d] = n[d]);
                        return (
                          (h = (0, s.getDocument)(u)),
                          (this.pdfLoadingTask = h),
                          (h.onPassword = function (e, t) {
                            f.passwordPrompt.setUpdateCallback(e, t),
                          ...
                          e.abrupt(
                            ...
                            h.promise.then(
                              ...
                              function (e) {
                                ...
                                return (
                                  (i.message = n),
                                  window.setCustomError(i),
                                  t.then(function (e) {
                                    throw (f.error(e, i), new Error(e));
                                  })
                                );
                              }
                            )
        ...
        error: function (e, t) {
          ...
          t &&
            ...
            t.errorMessage &&
              (t.errorOverride
                ? ((n.length = 0), n.push(t.errorMessage))
                : (t.errorAppend, n.push(t.errorMessage)));
        ...
        load: function (e) {
          ...
          v.setDocument(e),
                  ...
                  (function () {
                    var n = I(
                      r.default.mark(function n(i) {
                        var s, u, l, h, p, v, g, m, w, y, b, _, P, S;
                            ...
                            switch ((n.prev = n.next)) {
                              case 0:
                                return (
                                  ...
                                  (m = t.initialBookmark),
                                  (w = o.AppOptions.get('defaultZoomValue')),
                                  (y = w ? 'zoom='.concat(w) : null),
                                  (b = null),
                                  (_ = o.AppOptions.get('sidebarViewOnLoad')),
                                  (P = o.AppOptions.get('scrollModeOnLoad')),
                                  (S = o.AppOptions.get('spreadModeOnLoad')),
                                  l.page &&
                                    g !== B &&
                                    ((y =
                                      'page='
                                    ...
                                    _ === c.SidebarView.UNKNOWN &&
                                      (_ = 0 | l.sidebarView),
                                    P === a.ScrollMode.UNKNOWN &&
                                      (P = 0 | l.scrollMode),
                                    S === a.SpreadMode.UNKNOWN &&
                                      (S = 0 | l.spreadMode)),
                                  p &&
                                    _ === c.SidebarView.UNKNOWN &&
                                    (_ = Ne(p)),
                              ...
                              case 22:
                                (t.initialBookmark = m),
                                  (d.currentScaleValue = d.currentScaleValue),
                                  t.setInitialView(y);
                              case 25:
                              case 'end':
                                return n.stop();
            ...
            e.getPageLabels().then(function (n) {
              if (n && !o.AppOptions.get('disablePageLabels')) {
                var i = 0,
                  r = n.length;
                if (r === t.pagesCount) {
                  ...
                  i !== r &&
                    (d.setPageLabels(n),
                    v.setPageLabels(n),
                    t.toolbar.setPagesCount(e.numPages, !0),
                    t.toolbar.setPageNumber(
                      d.currentPageNumber,
                      d.currentPageLabel
                    ));
                } else
                  ...
                  if (e) {
                    e.some(function (e) {
                      return (
                        ...
                        t.fallback(s.UNSUPPORTED_FEATURES.javaScript),
                        !0)
                      );
                    });
                    for (
                      var n = /\bprint\s*\(/, i = 0, r = e.length;
                      i < r;
                      i++
                    ) {
                      var a = e[i];
            ...
            Promise.all([p, a.animationStarted]).then(function () {
            ...
            e.getMetadata().then(function (n) {
              var i,
                r = n.info,
                a = n.metadata,
                u = n.contentDispositionFilename;
              if (
                ((t.documentInfo = r),
                (t.metadata = a),
                ...
                console.log(
                  'PDF ' +
                    ...
                    '] (PDF.js: ' +
                    (s.version || '-') +
                    (o.AppOptions.get('enableWebGL') ? ' [WebGL]' : '') +
                    ')'
                ),
                a && a.has('dc:title'))
              ) {
                var l = a.get('dc:title');
                'Untitled' !== l && (i = l);
              }
              !i && r && r.Title && (i = r.Title),
                i
                  ? t.setTitle(''.concat(i, ' - ').concat(u || document.title))
                  : u && t.setTitle(u),
                r.IsAcroFormPresent &&
        ...
        beforePrint: function () {
          var e = this;
          let t = window.getUrlParameterByName('viewerId');
          if (t) {
            'true' == window.getUrlParameterByName('beforePrint') &&
              window.parent.postMessage(
                { viewerId: t, event: 'beforePrint' },
                '*'
              );
          }
            ...
            if (this.supportsPrinting)
              if (this.pdfViewer.pageViewsReady) {
                var n = this.pdfViewer.getPagesOverview(),
                  ...
                  r = Be.instance.createPrintService(
                    this.pdfDocument,
                    n,
                    i,
                    this.l10n
        ...
        afterPrint: function () {
          var e = window.getUrlParameterByName('viewerId');
          e &&
            'true' == window.getUrlParameterByName('afterPrint') &&
            window.parent.postMessage(
              { viewerId: e, event: 'afterPrint' },
              '*'
            );
          this.printService &&
        ...
        bindEvents: function () {
          ...
          (t.beforePrint = this.beforePrint.bind(this)),
            ...
            e.on('resize', Y),
            e.on('hashchange', J),
            e.on('beforeprint', t.beforePrint),
            e.on('afterprint', t.afterPrint),
            e.on('pagerendered', H),
            e.on('textlayerrendered', j),
            e.on('updateviewarea', Q),
            e.on('pagechanging', Se),
            e.on('scalechanging', _e),
            e.on('rotationchanging', Pe),
            e.on('sidebarviewchanged', K),
            e.on('pagemode', W),
            e.on('namedaction', G),
            e.on('presentationmodechanged', q),
            ...
            e.on('lastpage', re),
            e.on('nextpage', ae),
            e.on('previouspage', oe),
            e.on('zoomin', se),
            e.on('zoomout', ue),
            e.on('zoomreset', le),
            e.on('pagenumberchanged', ce),
            e.on('scalechanged', de),
            e.on('rotatecw', he),
            e.on('rotateccw', fe),
            e.on('switchscrollmode', pe),
            e.on('scrollmodechanged', Z),
            e.on('switchspreadmode', ve),
            e.on('spreadmodechanged', X),
            e.on('documentproperties', ge),
            e.on('find', me),
            e.on('findfromurlhash', we),
            e.on('updatefindmatchescount', ye),
            e.on('updatefindcontrolstate', be),
            e.on('fileinputchange', D);
        },
        bindWindowEvents: function () {
          ...
          (t.windowResize = function () {
            ...
            window.addEventListener('visibilitychange', ke),
        ...
        unbindEvents: function () {
          ...
          e.off('resize', Y),
            e.off('hashchange', J),
            e.off('beforeprint', t.beforePrint),
            e.off('afterprint', t.afterPrint),
            e.off('pagerendered', H),
            e.off('textlayerrendered', j),
            e.off('updateviewarea', Q),
            e.off('pagechanging', Se),
            e.off('scalechanging', _e),
            e.off('rotationchanging', Pe),
            e.off('sidebarviewchanged', K),
            e.off('pagemode', W),
            e.off('namedaction', G),
            e.off('presentationmodechanged', q),
            e.off('presentationmode', $),
            e.off('openfile', ee),
            e.off('print', te),
            e.off('download', ne),
            e.off('firstpage', ie),
            e.off('lastpage', re),
            e.off('nextpage', ae),
            e.off('previouspage', oe),
            e.off('zoomin', se),
            e.off('zoomout', ue),
            e.off('zoomreset', le),
            e.off('pagenumberchanged', ce),
            e.off('scalechanged', de),
            e.off('rotatecw', he),
            e.off('rotateccw', fe),
            e.off('switchscrollmode', pe),
            e.off('scrollmodechanged', Z),
            e.off('switchspreadmode', ve),
            e.off('spreadmodechanged', X),
            e.off('documentproperties', ge),
            e.off('find', me),
            e.off('findfromurlhash', we),
            e.off('updatefindmatchescount', ye),
            e.off('updatefindcontrolstate', be),
            e.off('fileinputchange', D),
            (t.beforePrint = null),
            (t.afterPrint = null);
        },
        unbindWindowEvents: function () {
          var e = this._boundEvents;
          window.removeEventListener('visibilitychange', ke),
    ...
    var A,
      D,
      R = ['null', 'http://mozilla.github.io', 'https://mozilla.github.io'];
    function F() {
      return (
    ...
    function U(e) {
      ...
      return (0, s.loadScript)(t.debuggerScriptPath).then(function () {
        PDFBug.enable(e),
          PDFBug.init(
            { OPS: s.OPS, createObjectURL: s.createObjectURL },
            t.mainContainer
          );
      });
    }
    function z() {
      ...
      (e = 'file' in i ? i.file : o.AppOptions.get('defaultUrl')), O(e);
      ...
      (r.id = t.openFileInputName),
        ...
        r.addEventListener('change', function (e) {
          ...
          t &&
            0 !== t.length &&
            V.eventBus.dispatch('fileinputchange', {
              source: this,
              fileInput: e.target,
            });
        }),
        ...
        t.mainContainer.addEventListener(
          ...
          function (e) {
            e.target === this &&
              V.eventBus.dispatch('resize', { source: this });
          },
          !0
        ),
        t.sidebar.toggleButton.addEventListener('click', function () {
          V.pdfSidebar.toggle();
        });
      try {
        A(e);
        ...
        V.l10n
          ...
          .then(function (t) {
            window.setCustomError(e), V.error(t, e);
          });
      }
    }
    function H(e) {
      var t = e.pageNumber,
        n = t - 1,
        i = V.pdfViewer.getPageView(n);
      if ((t === V.page && V.toolbar.updateLoadingIndicatorState(!1), i)) {
        if (V.pdfSidebar.isThumbnailViewVisible)
          V.pdfThumbnailViewer.getThumbnail(n).setImage(i);
    ...
    function q(e) {
      ...
      V.pdfViewer.presentationModeState = n
        ? a.PresentationModeState.CHANGING
        : t
        ? a.PresentationModeState.FULLSCREEN
        : a.PresentationModeState.NORMAL;
    }
    function K(e) {
      V.pdfRenderingQueue.isThumbnailViewEnabled =
        V.pdfSidebar.isThumbnailViewVisible;
      var t = V.store;
      t &&
        V.isInitialViewSet &&
    ...
    function Q(e) {
      ...
      n &&
        ...
        n
          ...
          .catch(function () {});
      var i = V.pdfLinkService.getAnchorUrl(t.pdfOpenParams);
      (V.appConfig.toolbar.viewBookmark.href = i),
        (V.appConfig.secondaryToolbar.viewBookmarkButton.href = i);
      var r =
        V.pdfViewer.getPageView(V.page - 1).renderingState !==
    ...
    function J(e) {
      ...
      t &&
        (V.isInitialViewSet
          ? V.pdfHistory.popStateInProgress || V.pdfLinkService.setHash(t)
          : (V.initialBookmark = t));
    }
    function $() {
    ...
    function ee() {
      var e = V.appConfig.openFileInputName;
    ...
    function le(e) {
      V.zoomReset(e && e.ignoreDuplicate);
    }
    function ce(e) {
      var t = V.pdfViewer;
    ...
    function me(e) {
      V.findController.executeCommand('find' + e.type, {
        query: e.query,
    ...
    function we(e) {
      V.findController.executeCommand('find', {
        query: e.query,
        phraseSearch: e.phraseSearch,
        caseSensitive: !1,
        entireWord: !1,
    ...
    function be(e) {
      ...
      V.supportsIntegratedFind
        ...
        : V.findBar.updateUIState(t, n, i);
    }
    function _e(e) {
      V.toolbar.setPageScale(e.presetValue, e.scale), V.pdfViewer.update();
    }
    function Pe(e) {
    ...
    function Se(e) {
      var t = e.pageNumber;
      if (
        (V.toolbar.setPageNumber(t, e.pageLabel || null),
        V.secondaryToolbar.setPageNumber(t),
        V.pdfSidebar.isThumbnailViewVisible &&
          V.pdfThumbnailViewer.scrollThumbnailIntoView(t),
        'undefined' != typeof Stats && Stats.enabled)
      ) {
        var n = V.pdfViewer.getPageView(t - 1);
        n && n.stats && Stats.add(t, n.stats);
      }
      let i = window.getUrlParameterByName('viewerId');
      if (i) {
        'true' == window.getUrlParameterByName('pageChange') &&
          window.parent.postMessage(
            { viewerId: i, event: 'pageChange', param: t },
            '*'
          );
      }
    }
    function ke(e) {
      'visible' === document.visibilityState && Le();
    }
    (O = function (e) {
      if (void 0 !== e)
        try {
          var t = new s.URL(window.location.href).origin || 'null';
          if (R.includes(t)) return;
          var n = new s.URL(e, window.location.href);
          n.origin, n.protocol;
        } catch (e) {
          var i = e && e.message;
          throw (
      ...
      (A = function (e) {
        if (e && 0 === e.lastIndexOf('file:', 0)) {
          V.setTitleUsingUrl(e);
          var t = new XMLHttpRequest();
          return (
            (t.onload = function () {
              V.open(new Uint8Array(t.response));
            }),
            t.open('GET', e),
      ...
      (D = function (e) {
        if (!V.pdfViewer || !V.pdfViewer.isInPresentationMode) {
          var t = e.fileInput.files[0];
          if (
            s.URL.createObjectURL &&
            !o.AppOptions.get('disableCreateObjectURL')
          ) {
            var n = s.URL.createObjectURL(t);
            t.name && (n = { url: n, originalUrl: t.name }), V.open(n);
          } else {
            V.setTitleUsingUrl(t.name);
            var i = new FileReader();
            (i.onload = function (e) {
              var t = e.target.result;
              V.open(new Uint8Array(t));
            }),
    ...
    function Ce(e) {
      ...
      if (!t.isInPresentationMode)
        if (e.ctrlKey || e.metaKey) {
          var n = V.supportedMouseWheelZoomModifierKeys;
          if ((e.ctrlKey && !n.ctrlKey) || (e.metaKey && !n.metaKey)) return;
          if ((e.preventDefault(), Ee || 'hidden' === document.visibilityState))
            return;
          var i = t.currentScale,
            r = 3 * (0, a.normalizeWheelEventDelta)(e);
          r < 0 ? V.zoomOut(-r) : V.zoomIn(r);
    ...
    function Ie(e) {
      if (!V.overlayManager.active) {
        ...
        if (1 === i || 8 === i || 5 === i || 12 === i)
          switch (e.keyCode) {
            case 70:
              V.supportsIntegratedFind || (V.findBar.open(), (t = !0));
              break;
            case 71:
              if (!V.supportsIntegratedFind) {
                var o = V.findController.state;
                o &&
                  V.findController.executeCommand('findagain', {
                    query: o.query,
            ...
            case 96:
              ...
              break;
            case 38:
              (a || V.page > 1) && ((V.page = 1), (t = !0), (n = !0));
              break;
            case 40:
              (a || V.page < V.pagesCount) &&
                ((V.page = V.pagesCount), (t = !0), (n = !0));
          }
        if (1 === i || 8 === i)
          switch (e.keyCode) {
            case 83:
        ...
        if (3 === i || 10 === i)
          switch (e.keyCode) {
            case 80:
              V.requestPresentationMode(), (t = !0);
              break;
            case 71:
              V.appConfig.toolbar.pageNumber.select(), (t = !0);
          }
        ...
        if (
          ...
          if (0 === i) {
            ...
            switch (e.keyCode) {
              case 38:
              case 33:
                r.isVerticalScrollbarEnabled && (d = !0), (c = -1);
                break;
              case 8:
                a || (d = !0), (c = -1);
                break;
              case 37:
                r.isHorizontalScrollbarEnabled && (d = !0);
              case 75:
              case 80:
                c = -1;
                break;
              case 27:
                V.secondaryToolbar.isOpen &&
                  (V.secondaryToolbar.close(), (t = !0)),
                  !V.supportsIntegratedFind &&
                    V.findBar.opened &&
                    (V.findBar.close(), (t = !0));
                break;
              ...
              case 35:
                ...
                break;
              case 83:
                V.pdfCursorTools.switchTool(u.CursorTool.SELECT);
                break;
              case 72:
                V.pdfCursorTools.switchTool(u.CursorTool.HAND);
                break;
              case 82:
                V.rotatePages(90);
                break;
            ...
            0 === c ||
              (d && 'page-fit' !== r.currentScaleValue) ||
              (c > 0
                ? V.page < V.pagesCount && V.page++
                : V.page > 1 && V.page--,
              (t = !0));
          }
          if (4 === i)
          ...
          t ||
            ...
            (((e.keyCode >= 33 && e.keyCode <= 40) ||
              (32 === e.keyCode && 'BUTTON' !== l)) &&
              (n = !0)),
            n && !r.containsElement(s) && r.focus(),
            t && e.preventDefault();
        }
      }
    }
    ...
    (function (e) {
      ...
      var n = (function (e) {
        ...
        var b = Object.getPrototypeOf,
          _ = b && b(b(I([])));
        _ && _ !== i && r.call(_, o) && (y = _);
        var P = (w.prototype = g.prototype = Object.create(y));
        function S(e) {
              ...
              return new Promise(function (n, o) {
                !(function n(i, a, o, s) {
                  ...
                  if ('throw' !== u.type) {
                    var l = u.arg,
                      d = l.value;
                    return d && 'object' === t(d) && r.call(d, '__await')
  ...
  function (e, t, n) {
    ...
    Object.defineProperty(t, '__esModule', { value: !0 }),
      ...
      (t.isValidScrollMode = function (e) {
        return (
          Number.isInteger(e) && Object.values(d).includes(e) && e !== d.UNKNOWN
        );
      }),
      ...
      (t.getGlobalEventBus = function () {
        var e = arguments.length > 0 && void 0 !== arguments[0] && arguments[0];
        b || (b = new y({ dispatchToDOM: e }));
        return b;
      }),
      (t.getPDFFileNameFromURL = function (e) {
        var t = window.getUrlParameterByName('fileName');
        if (t) return t;
        var n =
          arguments.length > 1 && void 0 !== arguments[1]
            ? arguments[1]
      ...
      (t.backtrackBeforeAllVisibleElements = g),
      (t.getVisibleElements = function (e, t) {
        ...
        for (var d = i ? s : -1, h = c; h < l; h++) {
          var f = t[h],
            p = f.div,
            m = p.offsetLeft + p.clientLeft,
            w = p.offsetTop + p.clientTop,
            y = p.clientWidth,
            b = p.clientHeight,
            _ = m + y,
            P = w + b;
          if (-1 === d) P >= a && (d = P);
          else if ((i ? m : w) > d) break;
          if (!(P <= r || w >= a || _ <= o || m >= s)) {
            var S = Math.max(0, r - w) + Math.max(0, P - a),
              k = Math.max(0, o - m) + Math.max(0, _ - s),
              E = (((b - S) * (y - k) * 100) / b / y) | 0;
            u.push({ id: f.id, x: m, y: w, view: f, percent: E });
          }
        }
        var L = u[0],
          C = u[u.length - 1];
      ...
      (t.waitOnEventOrTimeout = function (e) {
        ...
        return new Promise(function (e, i) {
          ...
          function a(i) {
            t instanceof y ? t.off(n, o) : t.removeEventListener(n, o),
              l && clearTimeout(l),
              e(i);
          }
          var o = a.bind(null, m.EVENT);
          t instanceof y ? t.on(n, o) : t.addEventListener(n, o);
          var s = a.bind(null, m.TIMEOUT),
            l = setTimeout(s, r);
        });
      }),
    ...
    var d = { UNKNOWN: -1, VERTICAL: 0, HORIZONTAL: 1, WRAPPED: 2 };
    t.ScrollMode = d;
    var h = { UNKNOWN: -1, NONE: 0, ODD: 1, EVEN: 2 };
    function f(e, t) {
      return t
    ...
    t.NullL10n = p;
    var m = { EVENT: 'event', TIMEOUT: 'timeout' };
    t.WaitOnType = m;
    var w = new Promise(function (e) {
      window.requestAnimationFrame(e);
    });
    t.animationStarted = w;
    var y = (function () {
      function e() {
          ...
          },
          {
            ...
            set: function (e) {
              ...
              (this._indeterminate = isNaN(e)),
                (this._percent =
                  ((t = e), (n = 0), (i = 100), Math.min(Math.max(t, n), i))),
                this._updateBar();
            },
          },
        ]),
  ...
  function (e, t, n) {
    ...
    var s = { VIEWER: 2, API: 4, WORKER: 8, PREFERENCE: 128 };
    t.OptionKind = s;
    var u = {
      cursorToolOnLoad: { value: 0, kind: s.VIEWER + s.PREFERENCE },
      defaultUrl: {
        value: 'compressed.tracemonkey-pldi-09.pdf',
        kind: s.VIEWER,
      },
      defaultZoomValue: { value: '', kind: s.VIEWER + s.PREFERENCE },
      disableHistory: { value: !1, kind: s.VIEWER },
      disablePageLabels: { value: !1, kind: s.VIEWER + s.PREFERENCE },
      enablePrintAutoRotate: { value: !1, kind: s.VIEWER + s.PREFERENCE },
      enableWebGL: { value: !1, kind: s.VIEWER + s.PREFERENCE },
      eventBusDispatchToDOM: { value: !1, kind: s.VIEWER + s.PREFERENCE },
      externalLinkRel: {
      ...
      maxCanvasPixels: {
        value: 16777216,
        compatibility: r.viewerCompatibilityParams.maxCanvasPixels,
        kind: s.VIEWER,
      },
      pdfBugEnabled: { value: !1, kind: s.VIEWER + s.PREFERENCE },
      renderer: { value: 'canvas', kind: s.VIEWER + s.PREFERENCE },
      renderInteractiveForms: { value: !1, kind: s.VIEWER + s.PREFERENCE },
      sidebarViewOnLoad: { value: -1, kind: s.VIEWER + s.PREFERENCE },
      scrollModeOnLoad: { value: -1, kind: s.VIEWER + s.PREFERENCE },
      spreadModeOnLoad: { value: -1, kind: s.VIEWER + s.PREFERENCE },
      textLayerMode: { value: 1, kind: s.VIEWER + s.PREFERENCE },
      useOnlyCssZoom: { value: !1, kind: s.VIEWER + s.PREFERENCE },
      ...
      disableCreateObjectURL: {
        value: !1,
        compatibility: i.apiCompatibilityParams.disableCreateObjectURL,
        kind: s.API,
      },
      disableFontFace: { value: !1, kind: s.API + s.PREFERENCE },
      disableRange: { value: !1, kind: s.API + s.PREFERENCE },
      disableStream: { value: !1, kind: s.API + s.PREFERENCE },
      isEvalSupported: { value: !0, kind: s.API },
      maxImageSize: { value: -1, kind: s.API },
      pdfBug: { value: !1, kind: s.API },
      postMessageTransfers: { value: !0, kind: s.API },
      verbosity: { value: 1, kind: s.API },
      workerPort: { value: null, kind: s.WORKER },
      workerSrc: { value: '../build/pdf.worker.js', kind: s.WORKER },
    };
    (u.disablePreferences = { value: !1, kind: s.VIEWER }),
      (u.locale = {
    ...
    (window.getUrlParameterByName = function (e, t) {
      ...
      (window.setCustomError = function (e) {
        let t = window.getUrlParameterByName('errorMessage');
        if (t) {
          window.getUrlParameterByName('errorOverride') &&
            ((e.errorOverride = !0), (e.errorMessage = t)),
            window.getUrlParameterByName('errorAppend') &&
              ((e.errorAppend = !0), (e.errorMessage = t));
        }
      }),
      (window.applyUserDefaults = function (e) {
        let t = window.getUrlParameterByName('locale');
        t && e.set('locale', t),
          window.getUrlParameterByName('useOnlyCssZoom') &&
            e.set('useOnlyCssZoom', !0);
      }),
      (window.applyParameterOverride = function (e) {
        'false' === window.getUrlParameterByName('openFile') &&
          (e.toolbar.openFile.setAttribute('hidden', 'true'),
          e.secondaryToolbar.openFileButton.setAttribute('hidden', 'true')),
          'false' === window.getUrlParameterByName('download') &&
            (e.toolbar.download.setAttribute('hidden', 'true'),
            e.secondaryToolbar.downloadButton.setAttribute('hidden', 'true')),
          'false' === window.getUrlParameterByName('viewBookmark') &&
            (e.toolbar.viewBookmark.setAttribute('hidden', 'true'),
            e.secondaryToolbar.viewBookmarkButton.setAttribute(
              'hidden',
              'true'
            )),
          'false' === window.getUrlParameterByName('print') &&
            (e.toolbar.print.classList.add('hidden'),
            e.secondaryToolbar.printButton.classList.add('hidden')),
          'false' === window.getUrlParameterByName('fullScreen') &&
            (e.toolbar.presentationModeButton.classList.add('hidden'),
            e.secondaryToolbar.presentationModeButton.classList.add('hidden')),
          'false' === window.getUrlParameterByName('find') &&
            e.toolbar.viewFind.classList.add('hidden');
      }),
      window.applyUserDefaults(c),
      (t.AppOptions = c);
  },
  function (e, t, n) {
    'use strict';
  ...
  function (e, t, n) {
    ...
    var i = Object.create(null),
      ...
      a = /Android/.test(r);
    (/\b(iPad|iPhone|iPod)(?=;)/.test(r) || a) && (i.maxCanvasPixels = 5242880),
      (t.viewerCompatibilityParams = Object.freeze(i));
  },
  function (e, t, n) {
    'use strict';
    Object.defineProperty(t, '__esModule', { value: !0 }),
  ...
  function (e, t, n) {
    ...
    var d = ['en-us', 'en-lr', 'my'],
      h = { '8.5x11': 'Letter', '8.5x14': 'Legal' },
      f = { '297x420': 'A3', '210x297': 'A4' };
    function p(e, t, n) {
    ...
    var v = (function () {
      function e(t, n, i) {
        ...
        !(function (e, t) {
          ...
          (this.l10n = c),
          this._reset(),
          l && l.addEventListener('click', this.close.bind(this)),
          this.overlayManager.register(
            this.overlayName,
            this.container,
            this.close.bind(this)
          ...
          c.getLanguage().then(function (e) {
            r._isNonMetricLocale = d.includes(e);
          });
      }
      var t, n, i;
      return (
                          ...
                          case 2:
                            return (
                              ...
                              (c = p(a, i, h) || p(s, i, f)) ||
                                ...
                                Math.abs(d.width - v.width) < 0.1 &&
                                  Math.abs(d.height - v.height) < 0.1 &&
                                  (c = p(v, i, f)) &&
                                  ((a = {
                                    width:
                                      Math.round((v.width / 25.4) * 100) / 100,
                                    height:
                                      Math.round((v.height / 25.4) * 100) / 100,
                                  }),
                                  (s = v))),
                              c &&
                                (u = this.l10n.get(
      ...
      function e(t) {
        ...
        !(function (e, t) {
          ...
          this.bar.addEventListener('keydown', function (e) {
            switch (e.keyCode) {
              case 13:
                e.target === n.findField &&
                  n.dispatchEvent('again', e.shiftKey);
                break;
              case 27:
                n.close();
            }
          ...
          },
          {
            ...
            value: function (e, t, n) {
              var i = this,
                ...
                s = '';
              switch (e) {
                case r.FindState.FOUND:
                  break;
                case r.FindState.PENDING:
                  s = 'pending';
                  break;
                case r.FindState.NOT_FOUND:
                  (o = this.l10n.get(
                    'find_not_found',
                    null,
                    'Phrase not found'
  ...
  function (e, t, n) {
    ...
    var d = (function () {
      function e(t) {
        var n = t.linkService,
          r = t.eventBus,
          a = void 0 === r ? (0, i.getGlobalEventBus)() : r;
        !(function (e, t) {
          if (!(e instanceof t))
            throw new TypeError('Cannot call a class as a function');
        })(this, e),
          ...
          (this._eventBus = a),
          this._reset(),
          a.on('findbarclose', this._onFindBarClose.bind(this));
      }
      var t, n, u;
      return (
        (t = e),
          ...
          },
          {
            ...
            value: function (e) {
              ...
              if (
                ...
                -1 !== a &&
                a === this._selected.pageIdx
              ) {
                this._scrollMatches = !1;
                var u = { top: -50, left: -400 };
                (0, i.scrollIntoView)(n, u, !0);
              }
            },
          },
          {
            ...
            value: function () {
              (this._highlightMatches = !1),
                ...
                (this._firstPageCapability = (0, r.createPromiseCapability)());
            },
          },
          {
            ...
            value: function (e, t, n) {
              if (t > 0) {
                var i = e.charCodeAt(t),
                  r = e.charCodeAt(t - 1);
                if ((0, a.getCharacterType)(i) === (0, a.getCharacterType)(r))
                  return !1;
              }
              var o = t + n - 1;
              if (o < e.length - 1) {
                var s = e.charCodeAt(o),
                  u = e.charCodeAt(o + 1);
                if ((0, a.getCharacterType)(s) === (0, a.getCharacterType)(u))
                  return !1;
              }
              return !0;
            },
  ...
  function (e, t, n) {
    ...
    function u(e) {
      var t = unescape(s()).substring(1),
        n = 0 | (0, i.parseQueryString)(t).page;
      return (
        (Number.isInteger(n) && n > 0 && n <= e.pagesCount) || (n = null),
        { hash: t, page: n, rotation: e.rotation }
      );
    }
    var l = (function () {
      function e(t) {
        ...
        !(function (e, t) {
          ...
          (this.linkService = r),
          (this.eventBus = a || (0, i.getGlobalEventBus)()),
          (this.initialized = !1),
          (this.initialBookmark = null),
          ...
          (this.applyActionsOverride = function () {
            let e = 0,
              t = 1,
              i = 2,
              r = window.getUrlParameterByName('cursor');
            if (r)
              switch ((r = r.toUpperCase())) {
                case 'HAND':
                case 'H':
                  PDFViewerApplication.pdfCursorTools.switchTool(t);
                  break;
                case 'ZOOM':
                case 'Z':
                  PDFViewerApplication.pdfCursorTools.switchTool(i);
                  break;
                case 'SELECT':
                case 'S':
                default:
                  PDFViewerApplication.pdfCursorTools.switchTool(e);
              }
            let a = 0,
              o = 1,
              s = 2,
              u = window.getUrlParameterByName('scroll');
            if (u)
              switch ((u = u.toUpperCase())) {
                case 'HORIZONTAL':
                case 'H':
                  PDFViewerApplication.pdfViewer.scrollMode = o;
                  break;
                case 'WRAPPED':
                case 'W':
                  PDFViewerApplication.pdfViewer.scrollMode = s;
                  break;
                case 'VERTICAL':
                case 'V':
                default:
                  PDFViewerApplication.pdfViewer.scrollMode = a;
              }
            let l = 0,
              c = 1,
              d = 2,
              h = window.getUrlParameterByName('spread');
            if (h)
              switch ((h = h.toUpperCase())) {
                case 'ODD':
                case 'O':
                  PDFViewerApplication.pdfViewer.spreadMode = c;
                  break;
                case 'EVEN':
                case 'E':
                  PDFViewerApplication.pdfViewer.spreadMode = d;
                  break;
                case 'NONE':
                case 'N':
                default:
                  PDFViewerApplication.pdfViewer.spreadMode = l;
              }
            window.getUrlParameterByName('startDownload') &&
              n.eventBus.dispatch('download', { source: n }),
              window.getUrlParameterByName('startPrint') &&
                n.eventBus.dispatch('print', { source: n }),
              window.getUrlParameterByName('lastpage') &&
                n.eventBus.dispatch('lastpage', { source: n }),
              window.getUrlParameterByName('rotatecw') &&
                n.eventBus.dispatch('rotatecw', { source: n }),
              window.getUrlParameterByName('rotateccw') &&
                n.eventBus.dispatch('rotateccw', { source: n });
          }),
          this.eventBus.on('pagesloaded', function (e) {
            n.applyActionsOverride(n), (n._isPagesLoaded = !!e.pagesCount);
            let t = window.getUrlParameterByName('viewerId');
            if (t) {
              'true' == window.getUrlParameterByName('pagesLoaded') &&
                window.parent.postMessage(
                  { viewerId: t, event: 'pagesLoaded', param: e.pagesCount },
                  '*'
                );
            }
          });
        ...
        (n = [
          {
            ...
            value: function (e) {
              ...
              if (t && 'string' == typeof t) {
                var o = this.initialized && this.fingerprint !== t;
                (this.fingerprint = t),
                  (this._updateUrl = !0 === a),
                  this.initialized || this._bindEvents();
                ...
                if (
                  ...
                  (this._position = null),
                  !this._isValidState(l, !0) || i)
                ) {
                  var c = u(this.linkService),
                    d = c.hash,
                    h = c.page,
                    f = c.rotation;
                  return !d || o || i
                    ...
                    : void this._pushOrReplaceState(
                        { hash: d, page: h, rotation: f },
                        !0
                      );
                }
                var p = l.destination;
                this._updateInternalState(p, l.uid, !0),
                  this._uid > this._maxUid && (this._maxUid = this._uid),
                  void 0 !== p.rotation && (this.initialRotation = p.rotation),
                  p.dest
                    ? ((this.initialBookmark = JSON.stringify(p.dest)),
                      (this._destination.page = null))
                    : p.hash
                    ? (this.initialBookmark = p.hash)
                    : p.page && (this.initialBookmark = 'page='.concat(p.page));
              } else
                console.error(
            ...
            value: function (e) {
              ...
              if (e.fingerprint !== this.fingerprint) {
                ...
                if (
                  ...
                  e.fingerprint.length !== this.fingerprint.length
                )
                  return !1;
            ...
            value: function (e) {
              ...
              if (((this._currentHash = r), n)) {
                ...
                var l = u(this.linkService),
                  ...
                  d = l.page,
                  h = l.rotation;
                this._pushOrReplaceState({ hash: c, page: d, rotation: h }, !0);
              }
            },
          },
          {
            ...
            value: function () {
              var e = this,
                t = this._boundEvents,
                n = this.eventBus;
              (t.updateViewarea = this._updateViewarea.bind(this)),
                (t.popState = this._popState.bind(this)),
                (t.pageHide = function (t) {
                  (e._destination && !e._destination.temporary) ||
                    e._tryPushCurrentPosition();
                }),
                n.on('updateviewarea', t.updateViewarea),
                window.addEventListener('popstate', t.popState),
    ...
    var u = (function () {
      function e() {
        var t =
          ...
          u = void 0 === s ? null : s;
        a(this, e),
          (this.eventBus = n || (0, i.getGlobalEventBus)()),
          (this.externalLinkTarget = o),
          (this.externalLinkRel = u),
          (this.baseUrl = null),
          (this.pdfDocument = null),
          (this.pdfViewer = null),
            ...
            value: function (e) {
              ...
              if (e.includes('=')) {
                ...
                if (
                  ...
                  return void this.navigateTo(a.nameddest);
                if (('page' in a && (t = 0 | a.page || 1), 'zoom' in a)) {
                  var o = a.zoom.split(','),
                    s = o[0],
                    u = parseFloat(s);
                  s.includes('Fit')
                ...
                if (
                  ...
                  (function (e) {
                    ...
                    if (
                      ...
                      return !1;
                    var a = e[1];
                    if ('object' !== r(a) || 'string' != typeof a.name)
                      return !1;
                    switch (a.name) {
                      case 'XYZ':
                        if (5 !== t) return !1;
    ...
    var a = (function () {
      function e(t) {
        ...
        !(function (e, t) {
          ...
          (this.eventBus = r),
          this.reset(),
          r.on('toggleoutlinetree', this.toggleOutlineTree.bind(this));
      }
      var t, n, a;
      return (
        (t = e),
        (n = [
          ...
          },
          {
            ...
            value: function (e) {
              ...
              (n.className = 'outlineItemToggler'),
                (n.onclick = function (i) {
                  if (
                    (i.stopPropagation(),
                    n.classList.toggle('outlineItemsHidden'),
                    i.shiftKey)
                  ) {
            ...
            value: function (e) {
              ...
              try {
                for (
                  ...
                  a.value.classList.toggle('outlineItemsHidden', !t);
                }
              } catch (e) {
                (i = !0), (r = e);
              } finally {
              ...
              if (
                ...
                for (
                  var r = document.createDocumentFragment(),
                    a = [{ parent: r, items: this.outline }],
                    o = !1;
                  a.length > 0;

                )
                  for (
                    var s = a.shift(), u = 0, l = s.items.length;
                    u < l;
                    u++
                  ) {
                    var c = s.items[u],
                    ...
                    if (
                      ...
                      this._setStyles(h, c),
                      (h.textContent =
                        (0, i.removeNullCharacters)(c.title) || '–'),
                      d.appendChild(h),
                      c.items.length > 0)
                    ) {
                      (o = !0), this._addToggleButton(d);
                      var f = document.createElement('div');
                      (f.className = 'outlineItems'),
                        d.appendChild(f),
                        a.push({ parent: f, items: c.items });
                    }
      ...
      o = (function () {
        function e(t) {
          ...
          !(function (e, t) {
            ...
            (this.container = i),
            (this.viewer = a || i.firstElementChild),
            (this.pdfViewer = o),
            (this.eventBus = s),
            (this.active = !1),
            (this.args = null),
            ...
            l &&
              (l.contextFirstPage.addEventListener('click', function () {
                (n.contextMenuOpen = !1),
          ...
          (n = [
            {
              ...
              value: function () {
                ...
                return (
                  ...
                  e !== this._width &&
                    ((this._width = e),
                    this.doc.style.setProperty(a, ''.concat(e, 'px')),
                    !0)
                );
              },
            },
                ...
                e &&
                  e
                    ...
                    .then(function (n) {
                      ...
                      t._thumbnails[t._currentPageNumber - 1].div.classList.add(
                        'selected'
                      );
                    })
                    .catch(function (e) {
      ...
      d = (function () {
        function e(t) {
          ...
          (v.href = s.getAnchorUrl('#page=' + i)),
            this.l10n
              .get('thumb_page_title', { page: i }, 'Page {{page}}')
              .then(function (e) {
                v.title = e;
              }),
            (v.onclick = function () {
          ...
          var w = 2 * u;
          (m.style.width = this.canvasWidth + w + 'px'),
            (m.style.height = this.canvasHeight + w + 'px'),
            (this.ring = m),
            g.appendChild(m),
            v.appendChild(g),
            n.appendChild(v);
              ...
              value: function () {
                ...
                if (
                  ...
                  (n.id = t),
                    ...
                    (n.style.width = this.canvasWidth + 'px'),
                    (n.style.height = this.canvasHeight + 'px'),
                    (n.src = this.canvas.toDataURL()),
                    (this.image = n),
                    this.div.setAttribute('data-loaded', !0),
                    this.ring.appendChild(n),
                    (this.canvas.width = 0),
                    (this.canvas.height = 0),
                    delete this.canvas;
                }
            ...
            },
            {
              ...
              value: function () {
                ...
                var t = (0, i.createPromiseCapability)(),
                  n = function (n) {
                    o === e.renderTask && (e.renderTask = null),
                      n instanceof i.RenderingCancelledException
                        ? t.resolve(void 0)
                        : ((e.renderingState = a.RenderingStates.FINISHED),
                          e._convertCanvasToImage(),
                          n ? t.reject(n) : t.resolve(void 0));
                  },
                  r = {
                    canvasContext: this._getPageDrawContext(),
                    viewport: this.viewport.clone({ scale: this.scale }),
                  },
                  o = (this.renderTask = this.pdfPage.render(r));
                return (
                  (o.onContinue = function (t) {
        ...
        (a = [
          {
            ...
            value: function (e) {
              var n = e.pageDiv,
                ...
                a = e.pageNumber,
                o = void 0 === a ? null : a;
              if (!r && !this.isInPresentationMode) {
                var s = n.offsetLeft + n.clientLeft,
                  c = s + n.clientWidth,
                  d = this.container,
                  h = d.scrollLeft,
                  f = d.clientWidth;
                (this._isScrollModeHorizontal || s < h || c > h + f) &&
                  (r = { left: 0, top: 0 });
              }
              u(l(t.prototype), '_scrollIntoView', this).call(this, {
                pageDiv: n,
                pageSpot: r,
                pageNumber: o,
              });
          ...
          },
          {
            ...
            value: function () {
              return this.isInPresentationMode
                ...
                : u(l(t.prototype), '_getVisiblePages', this).call(this);
            },
          },
          {
            key: '_updateHelper',
            value: function (e) {
              if (!this.isInPresentationMode) {
                ...
                n || (t = e[0].id), this._setCurrentPageNumber(t);
              }
            },
          },
          {
    ...
    var h = (function () {
      function e(t) {
        ...
        (this._name = this.constructor.name),
          ...
          (this.eventBus = t.eventBus || (0, i.getGlobalEventBus)()),
        ...
        (n = [
          ...
          },
          {
            ...
            value: function (e) {
              ...
              if (
                ...
                var a = (0, o.createPromiseCapability)();
                ...
                var u = function (e) {
                  ...
                  l = e.getPage(1);
                (this.firstPagePromise = l),
                  l
                    .then(function (o) {
                      for (
                        var l = t.currentScale,
                          c = o.getViewport({ scale: l * i.CSS_UNITS }),
                          d = 1;
                        d <= n;
                        ++d
                      ) {
                        var h = null;
                        t.textLayerMode !== i.TextLayerMode.DISABLE && (h = t);
                        var f = new s.PDFPageView({
                      ...
                      t._spreadMode !== i.SpreadMode.NONE &&
                        ...
                        a.promise.then(function () {
                          if (e.loadingParams.disableAutoFetch) r.resolve();
                          else
                            for (
                              var i = n,
                                a = function (n) {
                        ...
                        t.findController && t.findController.setDocument(e),
          ...
          },
          {
            ...
            value: function (e) {
              var t = e.pageNumber,
                ...
                o = void 0 !== a && a;
              if (this.pdfDocument) {
                var s = Number.isInteger(t) && this._pages[t - 1];
                if (s)
                  if (!this.isInPresentationMode && r) {
                    var u,
                      ...
                      f = 0,
                      p = s.rotation % 180 != 0,
                      v = (p ? s.height : s.width) / s.scale / i.CSS_UNITS,
                    ...
                    switch (r[1].name) {
                      ...
                      case 'FitV':
                      case 'FitBV':
                        (c = r[2]), (h = v), (f = g), (m = 'page-height');
                        break;
                      case 'FitR':
                        (c = r[2]), (d = r[3]), (h = r[4] - c), (f = r[5] - d);
                        var w = this.removePageBorders
                            ? 0
                            : i.SCROLLBAR_PADDING,
                          y = this.removePageBorders ? 0 : i.VERTICAL_PADDING;
                        (u =
                          (this.container.clientWidth - w) / h / i.CSS_UNITS),
                          (l =
                            (this.container.clientHeight - y) /
                            f /
                            i.CSS_UNITS),
                    ...
                    if (
                      ...
                      var b = [
                          s.viewport.convertToViewportPoint(c, d),
                          s.viewport.convertToViewportPoint(c + h, d + f),
                        ],
                        _ = Math.min(b[0][0], b[1][0]),
                        P = Math.min(b[0][1], b[1][1]);
                      o || ((_ = Math.max(_, 0)), (P = Math.max(P, 0))),
                        this._scrollIntoView({
                          pageDiv: s.div,
                          pageSpot: { left: _, top: P },
                          pageNumber: t,
                        });
                    } else
                      this._scrollIntoView({ pageDiv: s.div, pageNumber: t });
          ...
          },
          {
            ...
            value: function (e) {
              return (
                !!this.pdfDocument &&
                (this.pageNumber < 1 || e > this.pagesCount
                  ? (console.error(
                      ''
  ...
  function (e, t, n) {
    ...
    var c = n(8).viewerCompatibilityParams.maxCanvasPixels || 16777216,
      d = (function () {
        function e(t) {
          !(function (e, t) {
            if (!(e instanceof t))
          ...
          (this.id = t.id),
            ...
            (this.eventBus = t.eventBus || (0, a.getGlobalEventBus)()),
            (this.renderingQueue = t.renderingQueue),
            ...
            },
            {
              ...
              value: function (e) {
                var t =
                  ...
                  r = this.div;
                (e.style.width = e.parentNode.style.width = r.style.width =
                  Math.floor(n) + 'px'),
                  (e.style.height = e.parentNode.style.height = r.style.height =
                    Math.floor(i) + 'px');
                var a =
              ...
              value: function () {
                ...
                if (
                  ...
                  return (
                    ...
                    Promise.reject(new Error('Page is not loaded'))
                  );
                ...
                if (
                  ...
                  (c.className = 'textLayer'),
                    ...
                    this.annotationLayer && this.annotationLayer.div
                      ? n.insertBefore(c, this.annotationLayer.div)
                      : n.appendChild(c),
  ...
  function (e, t, n) {
    ...
    var u = (function () {
      function e(t) {
        ...
        a(this, e),
          (this.textLayerDiv = n),
          (this.eventBus = r || (0, i.getGlobalEventBus)()),
              ...
              if (0 !== e.length) {
                ...
                for (var d = l; d < c; d++) {
                  ...
                  if (
                    ...
                    s && f.divIdx === s.divIdx
                      ? b(s.divIdx, s.offset, f.offset)
                      : (null !== s && b(s.divIdx, s.offset, u.offset), y(f)),
                    f.divIdx === p.divIdx)
                  )
                    b(f.divIdx, f.offset, p.offset, 'highlight' + g);
                  else {
                    b(f.divIdx, f.offset, u.offset, 'highlight begin' + g);
                    for (var m = f.divIdx + 1, w = p.divIdx; m < w; m++)
                      r[m].className = 'highlight middle' + g;
                    y(p, 'highlight end' + g);
                  }
                  s = p;
                }
                s && b(s.divIdx, s.offset, u.offset);
              }
              function y(e, t) {
                var n = e.divIdx;
                (r[n].textContent = ''), b(n, 0, e.offset, t);
              }
              function b(e, t, n, a) {
                var o = r[e],
                  s = i[e].substring(t, n),
    ...
    var s = (function () {
      function e(t, n, o) {
        ...
        !(function (e, t) {
          ...
          this.eventBus.on('baseviewerinit', function (e) {
        ...
        (n = [
          ...
          },
          {
            ...
            value: function (e) {
              ...
              this.eventBus.on('scrollmodechanged', n),
                this.eventBus.on('secondarytoolbarreset', function (e) {
          ...
          },
          {
            ...
            value: function (e) {
              ...
              this.eventBus.on('spreadmodechanged', n),
                this.eventBus.on('secondarytoolbarreset', function (e) {
    ...
    var d = (function (e) {
      function t(e) {
        ...
        return (
          ...
          (n = s(this, l(t).call(this, e))).eventBus.on('pagesinit', function (
            e
          ) {
        ...
        (a = [
          {
            key: '_resetView',
            value: function () {
              u(l(t.prototype), '_resetView', this).call(this),
          ...
          },
          {
            ...
            value: function () {
              this._updateScrollDown && this._updateScrollDown(),
                u(l(t.prototype), '_scrollUpdate', this).call(this);
            },
          },
          {
            key: '_scrollIntoView',
            value: function (e) {
              ...
              var c = this._currentPageNumber >= this._previousPageNumber;
              this._ensurePageViewVisible(),
                ...
                (this._updateScrollDown = function () {
                  (n.scroll.down = c), (n._updateScrollDown = null);
                });
            },
          },
          {
          ...
          },
          {
            ...
            value: function () {
              (this.pageNumber = 0),
                ...
                (this.pagesCount = 0),
                (this.pageScaleValue = i.DEFAULT_SCALE_VALUE),
                (this.pageScale = i.DEFAULT_SCALE),
                this._updateUIState(!0);
            },
          },
          {
            ...
            value: function () {
              ...
              n.previous.addEventListener('click', function () {
                ...
                n.scaleSelect.addEventListener('change', function () {
                  'custom' !== this.value &&
                    t.dispatch('scalechanged', {
                      source: r,
                      value: this.value,
                    });
                }),
                n.presentationModeButton.addEventListener('click', function () {
                  t.dispatch('presentationmode', { source: r });
                }),
                n.openFile.addEventListener('click', function () {
                  t.dispatch('openfile', { source: r });
                }),
                n.print.addEventListener('click', function () {
                  t.dispatch('print', { source: r });
                }),
                n.download.addEventListener('click', function () {
                  t.dispatch('download', { source: r });
                }),
                (n.scaleSelect.oncontextmenu = i.noContextMenuHandler),
                t.on('localized', function () {
                  e._localized();
                });
            },
          },
            ...
            value: function () {
              ...
              if (this._wasLocalized) {
                ...
                e &&
                  ...
                  (o.next.disabled = t >= n),
                  (o.zoomOut.disabled = a <= i.MIN_SCALE),
                  (o.zoomIn.disabled = a >= i.MAX_SCALE);
                var s = Math.round(1e4 * a) / 100;
                this.l10n
                  .get('page_scale_percent', { scale: s }, '{{scale}}%')
                  .then(function (e) {
                    for (
                      var t = o.scaleSelect.options,
                        n = !1,
                        i = 0,
                        a = t.length;
                      i < a;
            ...
            value: function () {
              ...
              i.animationStarted.then(function () {
                if (
                  ...
                  t.setAttribute('style', 'min-width: ' + (n + 22) + 'px;'),
                    e.setAttribute(
                      'style',
  ...
  function (e, t, n) {
    ...
    var g = (function (e) {
      ...
      m = Object.create(a.DefaultExternalServices);
    (m.createDownloadManager = function (e) {
      return new s.DownloadManager(e);
    }),
      (m.createPreferences = function () {
        return new g();
      }),
      (m.createL10n = function (e) {
        var t = e.locale,
          n = void 0 === t ? 'en-US' : t;
        return new u.GenericL10n(n);
      }),
      (a.PDFViewerApplication.externalServices = m);
  },
  function (e, t, n) {
    'use strict';
    Object.defineProperty(t, '__esModule', { value: !0 }),
  ...
  function (e, t, n) {
    ...
    var a = i.apiCompatibilityParams.disableCreateObjectURL || !1;
    function o(e, t) {
    ...
    document.webL10n = (function (e, t, n) {
      ...
      function f(e, n) {
        e && (e = e.toLowerCase()),
          ...
          (o = e);
        var a,
          s = t.querySelectorAll('link[type="application/l10n"]'),
          l = s.length;
        if (0 === l) {
          var d = (a = t.querySelector('script[type="application/l10n"]'))
  ...
  function (e, t, n) {
    ...
    function u(e, t, n, r) {
      (this.pdfDocument = e),
        ...
        (this.disableCreateObjectURL = e.loadingParams.disableCreateObjectURL),
        (this.currentPage = -1),
      ...
      renderPages: function () {
        ...
        return new Promise(function n(r, a) {
          if ((e.throwIfInactive(), ++e.currentPage >= t))
            return h(t, t, e.l10n), void r();
          var s = e.currentPage;
          h(s, t, e.l10n),
            (function (e, t, n, r) {
              var a = o.scratchCanvas;
              (a.width = Math.floor(r.width * (150 / 72))),
                (a.height = Math.floor(r.height * (150 / 72)));
            ...
            })(0, e.pdfDocument, s + 1, e.pagesOverview[s])
    ...
    if (
      ...
      p &&
        document.attachEvent('onkeydown', function (e) {
          if (80 === (e = e || window.event).keyCode && e.ctrlKey)
    ...
    function g() {
      if (!f) {
        ...
        (f = s.register(
          ...
          (document.getElementById('printCancel').onclick = d);
      }
      return f;
    }
