  ...
  return (function (e) {
    ...
    function (e, t, r) {
      ...
      var i = r(8),
        ...
        H =
          ...
          c(function () {
            ...
            ? function (e, t, r) {
                var n = T(U, t);
                n && delete U[t], E(e, t, r), n && e !== U && E(U, t, n);
              }
            : E,
        X = function (e) {
        ...
        K = function (e) {
          ...
          return (
            !(this === U && a(q, e) && !a(W, e)) &&
            (!(t || !a(this, e) || !a(q, e) || (a(this, M) && this[M][e])) || t)
          );
        },
        J = function (e, t) {
          if (((e = A(e)), (t = S(t, !0)), e !== U || !a(q, t) || a(W, t))) {
            var r = T(e, t);
            return (
              !r || !a(q, t) || (a(e, M) && e[M][t]) || (r.enumerable = !0), r
            );
          }
        },
        Z = function (e) {
          for (var t, r = O(A(e)), n = [], i = 0; r.length > i; )
            a(q, (t = r[i++])) || t == M || t == l || n.push(t);
          return n;
        },
        $ = function (e) {
          for (
      ...
      B ||
        ...
        (r(74).f = K),
        (r(73).f = $),
        o && !r(25) && u(U, 'propertyIsEnumerable', K, !0),
        (v.f = function (e) {
          return X(p(e));
        })),
        s(s.G + s.W + s.F * !B, { Symbol: F });
      for (
      ...
      s(s.S + s.F * !B, 'Symbol', {
        ...
        F.prototype[j] || r(10)(F.prototype, j, F.prototype.valueOf),
        d(F, 'Symbol'),
        d(Math, 'Math', !0),
        d(i.JSON, 'JSON', !0);
    },
    ...
    function (e, t, r) {
      ...
      Object.defineProperty(t, '__esModule', { value: !0 }),
        (t.getDocument = function (e) {
          ...
          else if (e instanceof I) t = { range: e };
          else {
            if ('object' !== S(e))
              throw new Error(
                ...
                value: function () {
                  ...
                  e.on(
                    ...
                    e.on(
                      ...
                      function (e) {
                        if (!this.destroyed) {
                          var t = this.pageCache[e.pageIndex].intentStates[
                            e.intent
                          ];
    ...
    function (e, t, r) {
      ...
      var n,
        i = (n = r(148)) && n.__esModule ? n : { default: n },
        a = r(1);
      ...
      var y = { NONE: 0, SELF: 1, BLANK: 2, PARENT: 3, TOP: 4 };
      t.LinkTarget = y;
                ...
                value: function (e) {
                  ...
                  t ||
                    (((t = this.styleElement = document.createElement(
                      'style'
                    )).id = 'PDFJS_FONT_STYLE_TAG_'.concat(this.docId)),
                ...
                value: function (e, t, r) {
                  ...
                  document.body.appendChild(g),
                    (function e(t, r) {
                      if (++c > 30)
                        return (
                          (0, a.warn)('Load test font never loaded.'), void r()
                        );
                      (l.font = '30px ' + t),
                        l.fillText('.', 0, 20),
          ...
          (r.prototype = {
            ...
            getSizeAndScale: function (e, t, r) {
              ...
              var n = Math.max(3e3, t),
                i = Math.ceil(e * r);
              return i >= n ? (i = n) : (r = i / e), { scale: r, size: i };
            },
        ...
        _createStreamSink: function (e) {
          var t = this,
            ...
            d = {
              enqueue: function (e) {
                ...
                if (!this.isCancelled) {
                  ...
                  (this.desiredSize -= t),
                    ...
                    h({ stream: 'enqueue', chunk: e, transfers: r });
                }
              },
              close: function () {
                this.isCancelled ||
              ...
              error: function (e) {
                this.isCancelled ||
                  ((this.isCancelled = !0), h({ stream: 'error', reason: e }));
              },
              sinkCapability: c,
              onPull: null,
              onCancel: null,
          ...
          d.sinkCapability.resolve(),
            ...
            u(n[0], [e.data, d], n[1]).then(
              function () {
                h({ stream: 'start_complete', success: !0 });
              },
              function (e) {
                h({ stream: 'start_complete', success: !1, reason: e });
              }
            );
        },
          ...
          switch (e.stream) {
            ...
            case 'pull':
              if (!this.streamSinks[e.streamId]) {
                o({ stream: 'pull_complete', success: !0 });
                break;
              }
              this.streamSinks[e.streamId].desiredSize <= 0 &&
                ...
                u(this.streamSinks[e.streamId].onPull).then(
                  ...
                  function (e) {
                    o({ stream: 'pull_complete', success: !1, reason: e });
                  }
                );
              break;
            case 'enqueue':
            ...
            case 'cancel':
              ...
              u(this.streamSinks[e.streamId].onCancel, [c(e.reason)]).then(
                function () {
                  o({ stream: 'cancel_complete', success: !0 });
                },
                function (e) {
                  o({ stream: 'cancel_complete', success: !1, reason: e });
                }
              ),
              ...
              },
              {
                ...
                value: function (e, t) {
                  ...
                  for (
                    ...
                    if (l < 0) return null;
                    (o = e.substring(n, l)),
                      i.push({ name: s, value: this._resolveEntities(o) }),
                      (n = l + 1),
                      a();
                  }
    ...
    function (e, t, r) {
      ...
      var u = (function () {
        function e(e, t) {
          ...
          (this._pdfDataRangeTransport = t),
            ...
            this._pdfDataRangeTransport.addProgressListener(function (e, t) {
              r._onProgress({ loaded: e, total: t });
            }),
        ...
        function t(e, t) {
          ...
          try {
            for (
              var o, s = this._queuedChunks[Symbol.iterator]();
              !(n = (o = s.next()).done);
              n = !0
            ) {
              var u = o.value;
          ...
          (e.prototype = {
            ...
            getFullReader: function () {
              ...
              return (
                ...
                new t(this, e, this._progressiveDone)
              );
            },
    ...
    function (e, t, r) {
      ...
      var d = function (e) {
        ...
        p = { fontStyle: 'normal', fontWeight: 'normal', fillColor: '#000000' },
        ...
        A = 0,
        S = 0;
      t.SVGGraphics = h = (function () {
        function e(t, r, n) {
          for (var o in (u(this, e),
          ...
          c(e, [
            ...
            },
            {
              ...
              value: function (e) {
                return 'TilingPattern' === e[0]
                  ? ((0, i.warn)('Unimplemented pattern TilingPattern'), null)
                  ...
                  for (
                    ...
                    switch (0 | h.value) {
                      case i.OPS.rectangle:
                        ...
                        break;
                      case i.OPS.moveTo:
                        (n = t[s++]), (a = t[s++]), o.push('M', d(n), d(a));
                        break;
                      case i.OPS.lineTo:
                        (n = t[s++]), (a = t[s++]), o.push('L', d(n), d(a));
                        break;
                      case i.OPS.curveTo:
                        (n = t[s + 4]),
                          (a = t[s + 5]),
            ...
            },
            {
              ...
              value: function (e) {
                ...
                1 !== t &&
                  ...
                  e.setAttributeNS(null, 'stroke-miterlimit', d(r.miterLimit)),
            ...
            },
            {
              ...
              value: function (e, t, r) {
                ...
                i.setAttributeNS(v, 'xlink:href', n.src),
                  ...
                  i.setAttributeNS(
                    null,
                    'transform',
                    'scale('.concat(d(1 / t), ' ').concat(d(-1 / r), ')')
                  ),
            ...
            },
            {
              ...
              value: function (e, t) {
                ...
                o.setAttributeNS(v, 'xlink:href', i),
                  o.setAttributeNS(null, 'x', '0'),
                  o.setAttributeNS(null, 'y', d(-n)),
                  o.setAttributeNS(null, 'width', d(r) + 'px'),
                  o.setAttributeNS(null, 'height', d(n) + 'px'),
                  o.setAttributeNS(
                    null,
                    'transform',
                    'scale('.concat(d(1 / r), ' ').concat(d(-1 / n), ')')
                  ),
                  t
                    ? t.appendChild(o)
            ...
            { key: 'paintFormXObjectEnd', value: function () {} },
            {
              ...
              value: function (e) {
                ...
                return (
                  n.setAttributeNS(null, 'transform', f(e.transform)),
                  t.appendChild(n),
                  (this.svg = n),
                  t
                );
          ...
          function t(e, r, n) {
            ...
            return (
              ...
              i._setReadableStream(
                g.createReadStream(a, { start: r, end: n - 1 })
              ),
              i
            );
          }
      ...
      (l.prototype = {
        ...
        (c.prototype = {
          ...
          getFullReader: function () {
            return (
              (0, a.assert)(!this._fullRequestReader),
              (this._fullRequestReader = new h(this._manager, this._source)),
              this._fullRequestReader
            );
          },
          getRangeReader: function (e, t) {
            var r = new d(this._manager, e, t);
            return (
                            ...
                            switch ((e.prev = e.next)) {
                              ...
                              case 9:
                                return (
                                  ...
                                  e.abrupt('return', { value: a, done: !1 })
                                );
                              case 13:
                              case 'end':
                                return e.stop();
